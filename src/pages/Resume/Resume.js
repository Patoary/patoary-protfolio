...
const Resume = () => {
  ...
  return (
    <div id="resume" className="text-white max-w-7xl lg:mx-auto">
      ...
      <div className="min-h-[50vh]">
        ...
        >
          <label
            onClick={handleSkill}
            className={`tab-button py-7 px-14  text-xs lg:text-primary ${skill && "active-tab"
              } w-1/3`}
          >
            Profession Skills
          </label>
          <label
            ...
            className={`tab-button py-7 px-14  text-xs lg:text-primary ${education && "active-tab"
              } w-1/3`}
            aria-current="page"
          >
            Education
          ...
          <label
            ...
            className={`tab-button py-7 px-14  text-xs lg:text-primary ${trainee && "active-tab"
              } w-1/3`}
          >
